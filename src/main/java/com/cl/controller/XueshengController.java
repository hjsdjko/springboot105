...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XueshengEntity u = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xueshengxingming", username));
        if(u==null || !u.getXueshengmima().equals(password)) {
    ...
    public R register(@RequestBody XueshengEntity xuesheng){
    	...
    	XueshengEntity u = xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("xueshengxingming", xuesheng.getXueshengxingming()));
		if(u!=null) {
